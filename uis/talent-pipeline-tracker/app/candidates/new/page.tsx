...
export default function NewCandidatePage() {
  ...
  useEffect(() => {
    if (!submitSuccess || !createdCandidateId) {
      return;
    }
  ...
  }, [submitSuccess, createdCandidateId, router]);
      ...
      <main className="mx-auto max-w-2xl">
        ...
        <header className="mb-6">
          ...
          <h1 className="mt-1 text-2xl font-semibold text-zinc-900">
            Register New Candidate — TrackFlow Zaragoza
          </h1>
        </header>
        ...
        <div className="rounded-lg border border-zinc-200 bg-white p-6 shadow-sm">
          {submitSuccess && (
            <div
              ...
              role="status"
            >
              Candidate registered successfully. Redirecting to their profile…
            </div>
          )}
