...
Contact person: Must contain at least first and last name
Email: Must be valid format (contain @ and domain)
Phone: Must start with + followed by country code
Website: If provided, must be valid URL (start with http:// or https://)
Services of interest: At least one must be selected
